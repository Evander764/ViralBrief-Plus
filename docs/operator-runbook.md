...
微信视频号巡检只走独立按钮/API，不跟随网页日报混跑。系统会点击桌面微信左侧视频号小图标中心，再点击视频号窗口右上角小人入口；进入个人总览后，只点击左侧栏“关注”，不会点击顶部视频流“关注”。进入关注总览后会保护标题含“关注”的标签并关闭其他默认播放标签；每个博主默认读取 3 条非置顶视频，可在设置里调整为 1-10 条。采集到的文案、截图、点赞、转发、收藏/红心和评论先进入候选池，人工确认后才进入微信日报。
