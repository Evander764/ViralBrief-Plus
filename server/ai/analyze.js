...
重要规则：
- homepage_url：**除非你 100% 确信是真实可打开的抖音/小红书主页链接，否则一律留空字符串 ""**。绝对禁止编造、猜测或拼凑链接（抖音/小红书主页含不可猜测的用户 ID，猜的几乎都是死链）。视频号只使用桌面微信 App 巡检，wechat_channels 的 homepage_url 必须留空。
- nickname：填你知道的真实昵称。
  ...
  "suggestions": [
    {
      ...
      "nickname": "博主昵称",
      "homepage_url": "确切的抖音/小红书真实主页链接；视频号或不确定就留空",
      "category": "垂直领域",
      "priority": "S" | "A" | "B",
